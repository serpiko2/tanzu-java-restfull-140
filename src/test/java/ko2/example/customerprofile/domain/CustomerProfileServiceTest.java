package ko2.example.customerprofile.domain;

import ko2.example.customerprofile.data.CustomerProfileEntity;
import ko2.example.customerprofile.data.CustomerProfileRepository;
