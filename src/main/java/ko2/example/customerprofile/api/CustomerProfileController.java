package ko2.example.customerprofile.api;

import java.net.URI;
import java.util.List;
import java.util.stream.Collectors;

import ko2.example.customerprofile.domain.CustomerProfileChangeRequest;
import ko2.example.customerprofile.domain.CustomerProfileCreateRequest;
import ko2.example.customerprofile.domain.CustomerProfileResponse;
import ko2.example.customerprofile.domain.CustomerProfileService;
